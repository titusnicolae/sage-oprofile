# This file was *autogenerated* from the file batch/r02_2.sage.
...
__time__=misc.cputime(); __wall__=misc.walltime(); hermite(_sage_const_15 ,var('y',ns=_sage_const_1 )); print "Time: CPU %.2f s, Wall: %.2f s"%(misc.cputime(__time__), misc.walltime(__wall__))
